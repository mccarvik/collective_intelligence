...
###############################################
# Run and send output to a file
# "python stockvolume.py -> stockfeatures.txt"
# Nevermin, API deprecated
###############################################
...
for t in tickers:
  # Open the URL
  pdb.set_trace()
  rows=urllib2.urlopen('http://ichart.finance.yahoo.com/table.csv?s=%s&d=11&e=26&f=2006&g=d&a=3&b=12&c=1996' % t + '&ignore=.csv').readlines()

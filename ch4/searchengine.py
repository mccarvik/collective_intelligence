...
if __name__ == '__main__':
    ##### Crawler demo ##### 
    # pagelist = ['https://en.wikipedia.org/wiki/Sport']
    # crwl = crawler('')
    # crwl.crawl(pagelist)
    ...
    # print(e.getmatchrows('search lucky'))
    
    ##### Scoring Demo #####
    # e = searcher('searchindex.db')
    # print(e.query('search google'))
    
    ##### Calculate Page Rank #####
    crwl = crawler('searchindex.db')
    crwl.calculatepagerank()
    cur = crwl.con.execute('select * from pagerank order by score desc')
    for i in range(3):
        print cur.next()